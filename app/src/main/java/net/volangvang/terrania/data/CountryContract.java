...
import static net.volangvang.terrania.data.CountryContract.CountryEntry.COLUMN_CAPITAL_VI;
...
import static net.volangvang.terrania.data.CountryContract.CountryEntry.COLUMN_NAME_VI;
...
public final class CountryContract {
    ...
    public static abstract class CountryEntry implements BaseColumns {
        ...
        public static final String COLUMN_NAME_VI = "country_vi";
        public static final String COLUMN_REGION = "region";
        public static final String COLUMN_COUNTRY_CODE = "country_code";
        public static final String COLUMN_LATITUDE = "latitude";
        public static final String COLUMN_LONGITUDE = "longitude";
        public static final String COLUMN_CAPITAL = "capital";
        public static final String COLUMN_CAPITAL_VI = "capital_vi";
    ...
    COLUMN_COASTLINE, COLUMN_CURRENCY, COLUMN_DIALLING_PREFIX,
    ...
    public static final String[] PROJECTION_VI = {_ID, COLUMN_NAME_VI, COLUMN_REGION, COLUMN_COUNTRY_CODE,
            COLUMN_LATITUDE, COLUMN_LONGITUDE, COLUMN_CAPITAL_VI, COLUMN_POPULATION, COLUMN_AREA,
            COLUMN_COASTLINE, COLUMN_CURRENCY, COLUMN_DIALLING_PREFIX,
            COLUMN_BIRTH_RATE, COLUMN_DEATH_RATE, COLUMN_LIFE_EXPECTANCY};
    public static final String[] PROJECTION_LITE_VI = {_ID, COLUMN_NAME_VI, COLUMN_COUNTRY_CODE};
